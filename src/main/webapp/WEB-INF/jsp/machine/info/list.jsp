...
<div class="mt-5">
  <div class="container mx-auto px-3">
    ...
    <table border="1" class="table">
      ...
      <tbody>
        <c:set var="cnt" value="0" /> <!--중복되는 것을 카운트 해서 나중에 평균치를 내기 위해 변수 선언 -->
  
        <c:forEach var="room" items="${rooms}">  <!-- 이중반복문으로 공통 방이 있는지 확인 -->

          <c:set var="roomId" value="${room.id}" /> <!-- 우선 첫 번째 반복문 에서 id하나를 변수에 넣어 다음 반복문을 처음 부터 끝까지 돌리면서 비교하기 위해 변수 선언 -->
